...
public class Compiler implements Opcodes {
    ...
    // String
    static final public Var SOURCE_PATH = Var
            .intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("*file*"), "NO_SOURCE_PATH")
            .setDynamic();

    // String
    static final public Var COMPILE_PATH = Var
            .intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("*compile-path*"), null)
            .setDynamic();
    // boolean
    ...
    static {
        ...
        for (Map.Entry e : System.getProperties().entrySet()) {
            ...
            if (name.startsWith("clojure.compiler.")) {
                compilerOptions = RT.assoc(compilerOptions, RT.keyword(null, name.substring(1 + name.lastIndexOf('.'))),
                        RT.readString(v));
            }
        }
    ...
    static class DefExpr implements Expr {
        ...
        final static Method internVar = Method
                .getMethod("clojure.lang.Var refer(clojure.lang.Symbol, clojure.lang.Var)");

        public DefExpr(String source, int line, int column, Var var, Expr init, Expr meta, boolean initProvided,
                boolean isDynamic, boolean shadowsCoreMapping) {
            this.source = source;
            this.line = line;
            this.column = column;
            this.var = var;
        ...
        static class Parser implements IParser {
            public Expr parse(C context, Object form) {
                ...
                if (!v.ns.equals(currentNS())) {
                    ...
                    // throw Util.runtimeException("Name conflict, can't def " + sym + " because
                ...
                mm = (IPersistentMap) RT.assoc(mm, RT.LINE_KEY, LINE.get()).assoc(RT.COLUMN_KEY, COLUMN.get())
                ...
                return new DefExpr((String) SOURCE.deref(), lineDeref(), columnDeref(), v,
                        analyze(context == C.EVAL ? context : C.EXPRESSION, RT.third(form), v.sym.name), meta,
                        RT.count(form) == 3, isDynamic, shadowsCoreMapping);
            }
        }
    }
    ...
    static public abstract class HostExpr implements Expr, MaybePrimitiveExpr {
        ...
        public static void emitUnboxArg(ObjExpr objx, GeneratorAdapter gen, Class paramType) {
            if (paramType.isPrimitive()) {
                if (paramType == boolean.class) {
                    ...
                    // System.out.println("NOT fnexpr for defn var: " + var + "init: " +
                    // init.getClass());
                    Method m = null;
        ...
        static class Parser implements IParser {
            public Expr parse(C context, Object frm) {
                ...
                // static target must be symbol, either fully.qualified.Classname or Classname
                ...
                if (maybeField && !(((Symbol) RT.third(form)).name.charAt(0) == '-')) {
                    ...
                    if (c != null)
                        ...
                        maybeField = Reflector.getMethods(instance.getJavaClass(), 0, munge(sym.name), false)
                                .size() == 0;
                }
        ...
        /*
         * private static String maybeClassName(Object form, boolean stringOk){ String
         * className = null; if(form instanceof Symbol) { Symbol sym = (Symbol) form;
         * if(sym.ns == null) //if ns-qualified can't be classname {
         ...
         * else if(stringOk && form instanceof String) className = (String) form; return
         * className; }
         */
    ...
    static class StaticFieldExpr extends FieldExpr implements AssignableExpr {
        ...
        public final java.lang.reflect.Field field;
        public final Symbol tag;
        // final static Method getStaticFieldMethod = Method.getMethod("Object
        // getStaticField(String,String)");
        // final static Method setStaticFieldMethod = Method.getMethod("Object
        // setStaticField(String,String,Object)");
        final int line;
        final int column;
    ...
    static abstract class MethodExpr extends HostExpr {
        ...
        public static void emitTypedArgs(ObjExpr objx, GeneratorAdapter gen, Class[] parameterTypes,
    ...
    static class InstanceMethodExpr extends MethodExpr {
        ...
        public InstanceMethodExpr(String source, int line, int column, Symbol tag, Expr target, String methodName,
            ...
            if (target.hasJavaClass() && target.getJavaClass() != null) {
                ...
                if (methods.isEmpty()) {
                    ...
                    java.lang.reflect.Method m = (java.lang.reflect.Method) (methodidx >= 0 ? methods.get(methodidx)
                            : null);
        ...
        public Class getJavaClass() {
            if (jc == null)
                jc = retType((tag != null) ? HostExpr.tagToClass(tag) : null,
                        (method != null) ? method.getReturnType() : null);
            return jc;
        }
    }
    ...
    static class StaticMethodExpr extends MethodExpr {
        ...
        public StaticMethodExpr(String source, int line, int column, Symbol tag, Class c, String methodName,
                IPersistentVector args, boolean tailPosition) {
            this.c = c;
            this.methodName = methodName;
            this.args = args;
        ...
        public void emit(C context, ObjExpr objx, GeneratorAdapter gen) {
            if (method != null) {
                ...
                Type type = Type.getType(c);
                Method m = new Method(methodName, Type.getReturnType(method), Type.getArgumentTypes(method));
                gen.visitMethodInsn(INVOKESTATIC, type.getInternalName(), methodName, m.getDescriptor(),
                        c.isInterface());
                // if(context != C.STATEMENT || method.getReturnType() == Void.TYPE)
    ...
    public static class TryExpr implements Expr {
        ...
        static class Parser implements IParser {
            ...
            public Expr parse(C context, Object frm) {
                ...
                for (ISeq fs = form.next(); fs != null; fs = fs.next()) {
                    ...
                    if (!Util.equals(op, CATCH) && !Util.equals(op, FINALLY)) {
                        ...
                        if (Util.equals(op, CATCH)) {
                            ...
                            IPersistentMap dynamicBindings = RT.map(LOCAL_ENV, LOCAL_ENV.deref(), NEXT_LOCAL_NUM,
                                    NEXT_LOCAL_NUM.deref(), IN_CATCH_FINALLY, RT.T);
                            try {
                                Var.pushThreadBindings(dynamicBindings);
                                LocalBinding lb = registerLocal(sym,
                                        (Symbol) (RT.second(f) instanceof Symbol ? RT.second(f) : null), null, false);
                ...
                if (bodyExpr == null) {
                    // this codepath is hit when there is neither catch or finally, e.g. (try
                    // (expr))
        ...
        static class Parser implements IParser {
            public Expr parse(C context, Object form) {
                if (context == C.EVAL)
                    ...
                    throw Util
                            .runtimeException("Too few arguments to throw, throw expects a single Throwable instance");
                else if (RT.count(form) > 2)
                    throw Util
                            .runtimeException("Too many arguments to throw, throw expects a single Throwable instance");
    ...
    public static class IfExpr implements Expr, MaybePrimitiveExpr {
        ...
        public boolean hasJavaClass() {
            return thenExpr.hasJavaClass() && elseExpr.hasJavaClass()
                    && (thenExpr.getJavaClass() == elseExpr.getJavaClass() || thenExpr.getJavaClass() == RECUR_CLASS
        ...
        public boolean canEmitPrimitive() {
            try {
                return thenExpr instanceof MaybePrimitiveExpr && elseExpr instanceof MaybePrimitiveExpr
                        && (thenExpr.getJavaClass() == elseExpr.getJavaClass() || thenExpr.getJavaClass() == RECUR_CLASS
                                || elseExpr.getJavaClass() == RECUR_CLASS)
    ...
    static {
        System.out.println("We indy now baby!");
    ...
    public static class MapExpr implements Expr {
        ...
        static public Expr parse(C context, IPersistentMap form) {
            ...
            if (form instanceof IObj && ((IObj) form).meta() != null)
                return new MetaExpr(ret,
                        MapExpr.parse(context == C.EVAL ? context : C.EXPRESSION, ((IObj) form).meta()));
    ...
    static class KeywordInvokeExpr implements Expr {
        ...
        public void emit(C context, ObjExpr objx, GeneratorAdapter gen) {
            ...
            gen.invokeInterface(ObjExpr.ILOOKUP_SITE_TYPE, Method.getMethod("clojure.lang.ILookupThunk fault(Object)")); // target,new-thunk
    ...
    // public final String source;
    //
    // public KeywordSiteInvokeExpr(String source, int line, int column, Symbol tag,
    // Expr site, Expr target){
    // this.source = source;
    // this.site = site;
    // this.target = target;
    // this.line = line;
            ...
            for (java.lang.reflect.Method m : allmethods) {
                ...
                if (Modifier.isStatic(m.getModifiers()) && m.getName().equals("invokeStatic")) {
                    ...
                    if (argcount == params.length) {
                        ...
                        break;
                    } else if (argcount > params.length && params.length > 0
    ...
    static class InvokeExpr implements Expr {
            ...
            if (fexpr instanceof VarExpr) {
                ...
                if (pvar != null && PROTOCOL_CALLSITES.isBound()) {
                    ...
                    if (this.protocolOn != null) {
                        ...
                        if (mmapVal == null) {
                            throw new IllegalArgumentException("No method of interface: " + protocolOn.getName()
        ...
        void emitArgsAndCall(int firstArgToEmit, C context, ObjExpr objx, GeneratorAdapter gen) {
            ...
            gen.invokeInterface(IFN_TYPE,
                    new Method("invoke", OBJECT_TYPE, ARG_TYPES[Math.min(MAX_POSITIONAL_ARITY + 1, args.count())]));
        }
        ...
        static public Expr parse(C context, ISeq form) {
            ...
            if (RT.booleanCast(getCompilerOption(directLinkingKey)) && fexpr instanceof VarExpr && context != C.EVAL) {
                ...
                if (!v.isDynamic() && !RT.booleanCast(RT.get(v.meta(), redefKey, false))) {
                    ...
                    Expr ret = StaticInvokeExpr.parse(v, RT.next(form),
                            formtag != null ? formtag : sigtag != null ? sigtag : vtag, tailPosition);
                    if (ret != null) {
    ...
    static public class FnExpr extends ObjExpr {
        ...
        static Expr parse(C context, ISeq form, String name) {
            ...
            if (((IMeta) form.first()).meta() != null) {
                ...
                // fn.superName = (String) RT.get(RT.meta(form.first()), Keyword.intern(null,
                // "super-name"));
            }
            // fn.thisName = name;
            ...
            try {
                fn.compile(fn.isVariadic() ? "clojure/lang/RestFn" : "clojure/lang/AFunction",
                        (prims.size() == 0) ? null : prims.toArray(new String[prims.size()]), fn.onceOnly);
            } catch (IOException e) {
                throw Util.sneakyThrow(e);
            }
            fn.getCompiledClass();
        ...
        public void emitForDefn(ObjExpr objx, GeneratorAdapter gen) {
            ...
            // gen.invokeConstructor(thunkType,Method.getMethod("void
            // <init>(clojure.lang.Var,String)"));
            // }
            // else
    ...
    static public class ObjExpr implements Expr {
        ...
        void compile(String superName, String[] interfaceNames, boolean oneTimeUse) throws IOException {
            ...
            for (ISeq s = RT.keys(closes); s != null; s = s.next()) {
                ...
                if (isDeftype()) {
                    ...
                    FieldVisitor fv;
                    if (lb.getPrimitiveType() != null)
                        fv = cv.visitField(access, lb.name, Type.getType(lb.getPrimitiveType()).getDescriptor(), null,
                                null);
                    else
                        // todo - when closed-overs are fields, use more specific types here and in ctor
                        // and emitLocal?
            ...
            for (int i = 0; i < constants.count(); i++) {
                if (usedConstants.contains(i))
                    cv.visitField(ACC_PUBLIC + ACC_STATIC, constantName(i), constantType(i).getDescriptor(), null,
                            null);
            }

            // static fields for lookup sites
            for (int i = 0; i < keywordCallsites.count(); i++) {
                cv.visitField(ACC_STATIC, siteNameStatic(i), KEYWORD_LOOKUPSITE_TYPE.getDescriptor(), null, null);
        ...
        void emitValue(Object value, GeneratorAdapter gen) {
            ...
            // Method.getMethod("clojure.lang.KeywordCallSite
            // create(clojure.lang.Symbol)"));
            // }
                ...
                Method createMethod = Method
                        .getMethod(value.getClass().getName() + " create(clojure.lang.IPersistentMap)");
                ...
                if (vs == null)
                    ...
                    gen.invokeStatic(Type.getType(PersistentHashSet.class),
                            Method.getMethod("clojure.lang.PersistentHashSet create(Object[])"));
                }
                ...
                gen.invokeStatic(Type.getType(PersistentList.class),
                        Method.getMethod("clojure.lang.IPersistentList create(java.util.List)"));
        ...
        boolean isMutable(LocalBinding lb) {
            return isVolatile(lb) || RT.booleanCast(RT.contains(fields, lb.sym))
    ...
    public static class FnMethod extends ObjMethod {
        ...
        static FnMethod parse(ObjExpr objx, ISeq form, Object rettag) {
            ...
            try {
                ...
                Var.pushThreadBindings(RT.mapUniqueKeys(METHOD, method, LOCAL_ENV, LOCAL_ENV.deref(), LOOP_LOCALS, null,
                        NEXT_LOCAL_NUM, 0, CLEAR_PATH, pnode, CLEAR_ROOT, pnode, CLEAR_SITES, PersistentHashMap.EMPTY,
                ...
                for (int i = 0; i < parms.count(); i++) {
                    ...
                    if (p.equals(_AMP_)) {
                        ...
                        // {
                        // pc = Object.class;
                        // p = (Symbol) ((IObj) p).withMeta((IPersistentMap) RT.assoc(RT.meta(p),
                        // RT.TAG_KEY, null));
                        // }
                        // throw Util.runtimeException("Non-static fn can't have primitive parameter: "
                        // + p);
                        ...
                        argclasses.add(pc);
                        LocalBinding lb = pc.isPrimitive() ? registerLocal(p, null, new MethodParamExpr(pc), true)
        ...
        public void doEmitStatic(ObjExpr fn, ClassVisitor cv) {
            ...
            GeneratorAdapter gen = new GeneratorAdapter(ACC_PUBLIC + ACC_STATIC, ms, null,
            ...
            if (prim != null) {
                ...
                gen = new GeneratorAdapter(ACC_PUBLIC + ACC_FINAL, pm, null,
                        // todo don't hardwire this
                        EXCEPTION_TYPES, cv);
                gen.visitCode();
                for (int i = 0; i < argtypes.length; i++) {
        ...
        public void doEmitPrim(ObjExpr fn, ClassVisitor cv) {
            ...
            GeneratorAdapter gen = new GeneratorAdapter(ACC_PUBLIC + ACC_FINAL, ms, null,
                    // todo don't hardwire this
                    EXCEPTION_TYPES, cv);
            gen.visitCode();
        ...
        static void emitBody(ObjExpr objx, GeneratorAdapter gen, Class retClass, Expr body) {
            ...
            if (Util.isPrimitive(retClass) && be.canEmitPrimitive()) {
                ...
                if (bc == retClass)
                    ...
                    throw new IllegalArgumentException(
                            "Mismatched primitive return, expected: " + retClass + ", had: " + be.getJavaClass());
            } else {
    ...
    public static class LocalBinding {
        ...
        public boolean hasJavaClass() {
            if (hjc == null) {
                if (init != null && init.hasJavaClass() && Util.isPrimitive(init.getJavaClass())
        ...
        static class Parser implements IParser {
            public Expr parse(C context, Object frms) {
                ...
                for (; forms != null; forms = forms.next()) {
                    Expr e = (context != C.EVAL && (context == C.STATEMENT || forms.next() != null))
    ...
    public static class LetFnExpr implements Expr {
        ...
        public void emit(C context, ObjExpr objx, GeneratorAdapter gen) {
            ...
            Label end = gen.mark();
            // gen.visitLocalVariable("this", "Ljava/lang/Object;", null, loopLabel, end,
            // 0);
                    ...
                    try {
                            ...
                            try {
                                if (isLoop) {
                                    Var.pushThreadBindings(
                                            RT.map(CLEAR_PATH, clearpath, CLEAR_ROOT, clearroot, NO_RECUR, null));
                        ...
                        try {
                            if (isLoop) {
                                ...
                                Var.pushThreadBindings(RT.map(CLEAR_PATH, clearpath, CLEAR_ROOT, clearroot, NO_RECUR,
                                        null, METHOD_RETURN_CONTEXT, methodReturnContext));
            ...
            for (int i = 0; i < loopLocals.count(); i++) {
                ...
                if (lb.getPrimitiveType() != null) {
                    ...
                    if (pc == primc)
                        ...
                        (// source + ":" + line +
                                " recur arg for primitive local: " + lb.name + " is not matching primitive, had: "
                                        + (arg.hasJavaClass() ? arg.getJavaClass().getName() : "Object") + ", needed: "
                                        + primc.getName());
            ...
            public Expr parse(C context, Object frm) {
                ...
                for (int i = 0; i < loopLocals.count(); i++) {
                    ...
                    if (primc != null) {
                        ...
                        if (primc == long.class) {
                            if (!(pc == long.class || pc == int.class || pc == short.class || pc == char.class
                                    || pc == byte.class))
                                mismatch = true;
                        ...
                        if (mismatch) {
                            ...
                            if (RT.booleanCast(RT.WARN_ON_REFLECTION.deref()))
                                RT.errPrintWriter().println(source + ":" + line + " recur arg for primitive local: "
                                        ...
                                        + (pc != null ? pc.getName() : "Object") + ", needed: " + primc.getName());
                        }
                    }
                }
    ...
    private static Expr analyze(C context, Object form, String name) {
        ...
        try {
            ...
            else if (form instanceof IPersistentCollection && !(form instanceof IRecord) && !(form instanceof IType)
                    && ((IPersistentCollection) form).count() == 0) {
                Expr ret = new EmptyExpr(form);
                if (RT.meta(form) != null)
                    ret = new MetaExpr(ret,
                            MapExpr.parse(context == C.EVAL ? context : C.EXPRESSION, ((IObj) form).meta()));
                return ret;
    ...
    public static Object loadFile(String file) throws IOException {
        ...
        try {
            return load(new InputStreamReader(f, RT.UTF8), new File(file).getAbsolutePath(),
    ...
    public static Object load(Reader rdr, String sourcePath, String sourceName) {
        ...
        Object ret = null;
        LineNumberingPushbackReader pushbackReader = (rdr instanceof LineNumberingPushbackReader)
                ? (LineNumberingPushbackReader) rdr
                : new LineNumberingPushbackReader(rdr);
        consumeWhitespaces(pushbackReader);
        Var.pushThreadBindings(RT.mapUniqueKeys(LOADER, RT.makeClassLoader(), SOURCE_PATH, sourcePath, SOURCE,
                sourceName, METHOD, null, LOCAL_ENV, null, LOOP_LOCALS, null, NEXT_LOCAL_NUM, 0, RT.READEVAL, RT.T,
                RT.CURRENT_NS, RT.CURRENT_NS.deref(), LINE_BEFORE, pushbackReader.getLineNumber(), COLUMN_BEFORE,
                pushbackReader.getColumnNumber(), LINE_AFTER, pushbackReader.getLineNumber(), COLUMN_AFTER,
                pushbackReader.getColumnNumber(), RT.UNCHECKED_MATH, RT.UNCHECKED_MATH.deref(), RT.WARN_ON_REFLECTION,
    ...
    public static void pushNS() {
        Var.pushThreadBindings(PersistentHashMap
                .create(Var.intern(Symbol.intern("clojure.core"), Symbol.intern("*ns*")).setDynamic(), null));
    }

    public static void pushNSandLoader(ClassLoader loader) {
        Var.pushThreadBindings(RT.map(Var.intern(Symbol.intern("clojure.core"), Symbol.intern("*ns*")).setDynamic(),
                null, RT.FN_LOADER_VAR, loader, RT.READEVAL, RT.T));
    }
    ...
    public static Object compile(Reader rdr, String sourcePath, String sourceName) throws IOException {
        ...
        LineNumberingPushbackReader pushbackReader = (rdr instanceof LineNumberingPushbackReader)
                ? (LineNumberingPushbackReader) rdr
                : new LineNumberingPushbackReader(rdr);
        Var.pushThreadBindings(RT.mapUniqueKeys(SOURCE_PATH, sourcePath, SOURCE, sourceName, METHOD, null, LOCAL_ENV,
                null, LOOP_LOCALS, null, NEXT_LOCAL_NUM, 0, RT.READEVAL, RT.T, RT.CURRENT_NS, RT.CURRENT_NS.deref(),
                LINE_BEFORE, pushbackReader.getLineNumber(), COLUMN_BEFORE, pushbackReader.getColumnNumber(),
        ...
        try {
            ...
            ClassWriter cw = new CljClassWriter(objx.internalName,
                    ClassWriter.COMPUTE_MAXS + ClassWriter.COMPUTE_FRAMES);
            ClassVisitor cv = cw;
            cv.visit(V9, ACC_PUBLIC + ACC_SUPER, objx.internalName, null, "java/lang/Object", null);

            // static load method
            GeneratorAdapter gen = new GeneratorAdapter(ACC_PUBLIC + ACC_STATIC, Method.getMethod("void load ()"), null,
                    null, cv);
            gen.visitCode();
            ...
            for (int n = 0; n < numInits; n++) {
                GeneratorAdapter clinitgen = new GeneratorAdapter(ACC_PUBLIC + ACC_STATIC,
                        Method.getMethod("void __init" + n + "()"), null, null, cv);
                clinitgen.visitCode();
                try {
                    Var.pushThreadBindings(RT.map(RT.PRINT_DUP, RT.T));
    ...
    static public class NewInstanceExpr extends ObjExpr {
        ...
        static class DeftypeParser implements IParser {
            public Expr parse(C context, final Object frm) {
                ISeq rform = (ISeq) frm;
                // (deftype* tagname classname [fields] :implements [interfaces] :tag tagname
                // methods*)
                rform = RT.next(rform);
                ...
                ObjExpr ret = build((IPersistentVector) RT.get(opts, implementsKey, PersistentVector.EMPTY), fields,
                        null, tagname, classname, (Symbol) RT.get(opts, RT.TAG_KEY), rform, frm, opts);
                return ret;
            }
        }
        ...
        static class ReifyParser implements IParser {
            public Expr parse(C context, Object frm) {
                ...
                if (frm instanceof IObj && ((IObj) frm).meta() != null)
                    return new MetaExpr(ret,
                            MapExpr.parse(context == C.EVAL ? context : C.EXPRESSION, ((IObj) frm).meta()));
                else
                    return ret;
            }
        }
        ...
        static ObjExpr build(IPersistentVector interfaceSyms, IPersistentVector fieldSyms, Symbol thisSym,
                String tagName, Symbol className, Symbol typeTag, ISeq methodForms, Object frm, IPersistentMap opts) {
            ...
            if (fieldSyms != null) {
                ...
                for (int i = 0; i < fieldSyms.count(); i++) {
                    ...
                    LocalBinding lb = new LocalBinding(-1, sym, null, new MethodParamExpr(tagClass(tagOf(sym))), false,
                            null);
                ...
                for (int i = fieldSyms.count() - 1; i >= 0 && (((Symbol) fieldSyms.nth(i)).name.equals("__meta")
                        ...
                        || ((Symbol) fieldSyms.nth(i)).name.equals("__hasheq")); --i)
                    ret.altCtorDrops++;
            }
         ...
         * Work around this by: Generate a stub class that has the same interfaces and
         * fields as the class we are generating. Use it as a type hint for this, and
         * bind the simple name of the class to this stub (in resolve etc) Unmunge the
         * name (using a magic prefix) on any code gen for classes
         */
        static Class compileStub(String superName, NewInstanceExpr ret, String[] interfaceNames, Object frm) {
            ClassWriter cw = new CljClassWriter(ret.internalName,
                    ClassWriter.COMPUTE_MAXS + ClassWriter.COMPUTE_FRAMES);
            ClassVisitor cv = cw;
            cv.visit(V9, ACC_PUBLIC + ACC_SUPER, COMPILE_STUB_PREFIX + "/" + ret.internalName, null, superName,
                    interfaceNames);
            ...
            if (this.isDeftype()) {
                ...
                if (this.isDeftype() && this.fields.count() > this.hintedFields.count()) {
                    ...
                    for (ISeq s = RT.seq(hintedFields); s != null; s = s.next(), i++) {
                        ...
                        mv.visitMethodInsn(INVOKEINTERFACE, "clojure/lang/IPersistentMap", "valAt",
                        ...
                        mv.visitMethodInsn(INVOKESTATIC, "clojure/lang/Keyword", "intern",
                                "(Ljava/lang/String;)Lclojure/lang/Keyword;");
                        mv.visitMethodInsn(INVOKEINTERFACE, "clojure/lang/IPersistentMap", "without",
        ...
        protected void emitMethods(ClassVisitor cv) {
            ...
            for (Map.Entry<IPersistentVector, Set<Class>> e : covariants.entrySet()) {
                ...
                for (Class retType : e.getValue()) {
                    ...
                    GeneratorAdapter gen = new GeneratorAdapter(ACC_PUBLIC + ACC_BRIDGE, meth, null,
                            // todo don't hardwire this
                            EXCEPTION_TYPES, cv);
                    gen.visitCode();
                    gen.loadThis();
        ...
        static void considerMethod(java.lang.reflect.Method m, Map mm) {
            ...
            if (!(mm.containsKey(mk) || !(Modifier.isPublic(mods) || Modifier.isProtected(mods))
                ...
                if (matches.size() > 0) {
                    ...
                    if (matches.size() > 1) {
                        ...
                        if (m.getReturnType() != method.retClass)
                            throw new IllegalArgumentException("Mismatched return type: " + name.name + ", expected: "
                                    + m.getReturnType().getName() + ", had: " + method.retClass.getName());
                    } else // one match
                    {
    ...
    public static class CaseExpr implements Expr, MaybePrimitiveExpr {
        ...
        // (case* expr shift mask default map<minhash, [test then]> table-type test-type
        // skip-check?)
        public CaseExpr(int line, int column, LocalBindingExpr expr, int shift, int mask, int low, int high,
                Expr defaultExpr, SortedMap<Integer, Expr> tests, HashMap<Integer, Expr> thens, Keyword switchType,
                Keyword testType, Set<Integer> skipCheck) {
            this.expr = expr;
            this.shift = shift;
            this.mask = mask;
            this.low = low;
        ...
        private void emitExprForInts(ObjExpr objx, GeneratorAdapter gen, Type exprType, Label defaultLabel) {
            if (exprType == null) {
                ...
                emitShiftMask(gen);
            } else if (exprType == Type.LONG_TYPE || exprType == Type.INT_TYPE || exprType == Type.SHORT_TYPE
        ...
        private void emitThenForInts(ObjExpr objx, GeneratorAdapter gen, Type exprType, Expr test, Expr then,
        ...
        private void emitThenForHashes(ObjExpr objx, GeneratorAdapter gen, Expr test, Expr then, Label defaultLabel,
                boolean emitUnboxed) {
            expr.emit(C.EXPRESSION, objx, gen);
            test.emit(C.EXPRESSION, objx, gen);
        ...
        static class Parser implements IParser {
            ...
            public Expr parse(C context, Object frm) {
                ...
                for (Object o : caseMap.entrySet()) {
                    ...
                    Expr testExpr = testType == intKey ? NumberExpr.parse(((Number) RT.first(pair)).intValue())
                ...
                return new CaseExpr(line, column, testexpr, shift, mask, low, high, defaultExpr, tests, thens,
                        switchType, testType, skipCheck);
            }
        }
    }
