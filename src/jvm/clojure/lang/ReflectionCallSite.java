...
public abstract class ReflectionCallSite extends MutableCallSite {
  public static final MethodHandle GET_CLASS;
  public static final MethodHandle BOX_ARGS;
  public static final MethodHandle CLASS_MATCHES;
  ...
  private ReflectionCallSite(String methodName, MethodType type, MethodHandle handle) {
    super(type);
    this.methodName = methodName;
    this.setTarget(handle.bindTo(this));
  }

  public static CallSite createInstanceCache(String methodName) {
    return new Instance(methodName);
  }

  public static CallSite createStaticCache(String methodName) {
    return new Static(methodName);
  }

  public static final class Static extends ReflectionCallSite {
    public static final MethodType TYPE = MethodType.methodType(Object.class, Class.class, Object[].class);
    ...
    static {
      try {
          ...
          STATIC_METHOD_CACHE = LOOKUP.findVirtual(ReflectionCallSite.Static.class, "staticMethodCache", TYPE);
          CLASS_AND_ARGUMENTS_MATCH = LOOKUP.findStatic(ReflectionCallSite.Static.class, "classAndArgumentsMatch", MethodType.methodType(boolean.class, Class.class, Class[].class, Class.class, Object[].class));
      } catch (Exception e) {
        throw new RuntimeException("Failed to init bootstrap methods", e);
      }
    }
    ...
    private Static(String methodName) {
      super(methodName, TYPE, STATIC_METHOD_CACHE);
    }
  ...
  public static final class Instance extends ReflectionCallSite {
    ...
    static {
      try {
        ...
        INSTANCE_METHOD_CACHE = LOOKUP.findVirtual(ReflectionCallSite.Instance.class, "instanceMethodCache", TYPE);
        ...
        CLASS_AND_ARGUMENTS_MATCH = LOOKUP.findStatic(ReflectionCallSite.Instance.class, "classAndArgumentsMatch", MethodType.methodType(boolean.class, Class.class, Class[].class, Object.class, Object[].class));
      } catch (Exception e) {
        throw new RuntimeException("Failed to init bootstrap methods", e);
      }
    }

    private Instance(String methodName) {
      super(methodName, TYPE, INSTANCE_METHOD_CACHE);
    }
    ...
    private static final boolean classAndArgumentsMatch(Class c, Class[] paramTypes, Object target, Object[] args) {
      return c.isInstance(target) && Reflector.isCongruent(paramTypes, args);
    }
  }
}
