...
(deftest gen-interface-source-file
  (let [classReader (org.objectweb.asm.ClassReader. "clojure.test_clojure.genclass.examples.ArrayGenInterface")
        sourceFile (StringBuilder.)
        sourceVisitor (proxy [org.objectweb.asm.ClassVisitor] [org.objectweb.asm.Opcodes/ASM4 nil]
